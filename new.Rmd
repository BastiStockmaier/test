...
The correlation matrix divides the correlation matrix by something that represents the diversity and scale in the covariates and provides a new value, a correlation which  lays between -1 and 1. E.g for the correlation between variable x and y, we divide it by the square root of the variance of x times the variance of y. 
...
And again, if the number of variabels increases, cor() will create a correlation matrix for you.
